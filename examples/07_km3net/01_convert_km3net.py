...
def main(
    ...
    if HNL == "km3net-vars":
        ...
        truth_extractor = KM3NeTHNLTruthExtractor(name = "truth")
        reco_extractor = KM3NeTHNLRecoExtractor(name = "reco")

    if triggered == "Triggered":
        pulse_extractor = KM3NeTTriggPulseExtractor(name = "pulse_map")
    elif triggered == "Snapshot":
        pulse_extractor =  KM3NeTFullPulseExtractor(name = "pulse_map")
...
if __name__ == "__main__":
    ...
    parser.add_argument("backend", choices=["sqlite", "parquet"], help="Choose the backend format")
    parser.add_argument("triggered", choices=["Triggered", "Snapshot"], help="Choose between triggered or snapshot pulse maps")
    parser.add_argument("HNL", choices=["km3net-vars", "hnl-vars"], help="Km3net truth or adding Heavy Neutral Lepton info")
